...
img_referencia = cv2.imread("original.jpg")
# Imagem distorcida
# img_distorcida = cv2.imread("distorcido.jpg")
img_distorcida = cv2.imread("distorcido_menor.jpg")
...
imgKp_Ref = cv2.drawKeypoints(img_ref_cinza, keyPoint1, 0, (0,222,0), None)
# imgKp_Ref = cv2.drawKeypoints(img_ref_cinza, keyPoint2, 0, (0,222,0), None)
imgKp_Ref = cv2.resize(img_ref_cinza, (largura//2, altura//2))
